...
class Banco:
    ...
    def saque(self, numero_conta, valor):
        ...
        if numero_conta in self.__fichario and self.__fichario[numero_conta].get_saldo() >= valor:
    ...
    def transferencia(self, nct_origem, nct_destino, valor):
        ...
        if nct_origem in self.__fichario and nct_destino in self.__fichario and self.__fichario[nct_origem].get_saldo() >= valor:
